...
| `items/.gxx102.md.annotations.md` | ❌ No | Private workspace — internal notes, action links, term: commands |

The annotation sidecar is a hidden dotfile that Quartz never sees. In nb-web it renders stacked below the item card in the preview pane — your per-item command centre.
