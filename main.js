...
<style>
  ...
  @media print { body { margin: 0; } }
    ...
    // ── Template detail helpers (stranded here since the Templates split;
    //    see claude:mainjs-split-design.md's Templates-view deferral note) ──
...
<div class="nb-account-page" style="padding:28px 32px;max-width:520px">
  ...
  <section class="nb-acct-section">
    ...
    return { init, loadNotes, resetAndLoad, resetSort, search, openNote,
             ...
             // parseMarkdownStatic is called by NbPluginsPage (plugins-page.js) and by
             // kernel renderPreview + the not-yet-extracted Templates block.
             ...
             runCal, runGrep, runTemplates, runAccount, loadTemplatesForAdd,
