...
const CACHE = 'nb-web-v267';
const SHELL = [
    '/', '/index.html', '/styles.css',
    '/main.js', '/nav.js', '/nbweb.js', '/theme.js', '/terminal.js', '/dialog.js', '/drag-handles.js', '/note-actions.js', '/search.js', '/sync.js', '/plugins-page.js', '/notebooks-page.js', '/templates.js',
    '/nb-logo.png',
    '/settings.html',
    '/marked.min.js',
